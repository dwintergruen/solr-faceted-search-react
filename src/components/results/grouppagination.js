...
class GroupPagination extends React.Component {
	...
	render() {
		...
		if (typeof results.grouped  == "undefined" || typeof  results.grouped.source_i == "undefined"){
			var numFound = 0;
		}
		else {
            var numFound = results.grouped.source_i.groups.length;
        }
